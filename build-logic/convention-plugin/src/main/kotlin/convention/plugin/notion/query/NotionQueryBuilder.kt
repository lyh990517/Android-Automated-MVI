package convention.plugin.notion.query

import convention.plugin.notion.query.filter.Filter
import convention.plugin.notion.query.filter.Filter.Companion.toJson
import convention.plugin.notion.query.filter.FilterDslContext
import convention.plugin.notion.query.sort.Sort
import convention.plugin.notion.query.sort.Sort.Companion.toJson
import convention.plugin.notion.query.sort.SortDslContext
