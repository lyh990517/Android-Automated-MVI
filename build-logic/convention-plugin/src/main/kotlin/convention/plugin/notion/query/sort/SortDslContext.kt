package convention.plugin.notion.query.sort

import convention.plugin.notion.query.sort.builder.PropertySortBuilder
import convention.plugin.notion.query.sort.builder.TimestampSortBuilder
